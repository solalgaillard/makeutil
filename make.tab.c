...
#line 148 "make.tab.c" /* yacc.c:358  */
...
{
  "$end", "error", "$undefined", "YSTRING", "VAR_NAME", "VAR_SIGN",
  "LINESEPARATOR", "':'", "'='", "'('", "')'", "$accept", "program",
  "expr", ".canexpendvar", ".recstrings", YY_NULLPTR
};
#endif
...
#line 1235 "make.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 54 "make.y" /* yacc.c:1646  */
    {
...
#line 1244 "make.tab.c" /* yacc.c:1646  */
  ...
  case 7:
#line 66 "make.y" /* yacc.c:1646  */
    { (yyval.c)=(yyvsp[0].c); }
#line 1250 "make.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 68 "make.y" /* yacc.c:1646  */
    { (yyval.c)=(yyvsp[-1].c); }
#line 1256 "make.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 70 "make.y" /* yacc.c:1646  */
    { (yyval.c)=(yyvsp[0].c); }
...
#line 1268 "make.tab.c" /* yacc.c:1646  */
  ...
  case 11:
#line 76 "make.y" /* yacc.c:1646  */
    {
			(yyval.toklist)=(yyvsp[0].toklist);
			addToTokenList((yyvsp[-1].c), (yyvsp[0].toklist), 0);
		}
#line 1277 "make.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 81 "make.y" /* yacc.c:1646  */
    {
			(yyval.toklist)=(yyvsp[0].toklist);
			addToTokenList((yyvsp[-2].c), (yyvsp[0].toklist), (yyvsp[-4].i));
                }
#line 1286 "make.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 86 "make.y" /* yacc.c:1646  */
    {
			(yyval.toklist)=(yyvsp[0].toklist);
			addToTokenList((yyvsp[-1].c), (yyvsp[0].toklist), 1);
		}
#line 1295 "make.tab.c" /* yacc.c:1646  */
    break;


#line 1299 "make.tab.c" /* yacc.c:1646  */
      default: break;
    }
